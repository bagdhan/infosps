        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <center><h4 class="card-title">Jadwal Sidang Promosi Terbuka S3 SPs IPB</h4></center>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            PHYSICO-CHEMICAL AND ANATOMICAL PROPERTIES OF CARBONIZED INDONESIAN BAMBOO AND ITS APPROPRIATE UTILIZATION
                          </td>
						  <td>
                            Dr. Saptadi Darmawan
                          </td>
						  <td>
                            Dr.Ir. Jajang Suryana, M.Sc.
                          </td>
						  <td>
                            Jumat
                          </td>
						  ...
						  <td>
                            Ruang Sidang Silva Lantai 1 Fahutan-IPB Dramaga
                          </td>
						  <td>
                            #
                          </td>
